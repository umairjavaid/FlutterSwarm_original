...
class CommandManager {
    ...
    async createProject() {
        try {
            ...
            if (this.extension.mcp.isConnectedToServer()) {
                const result = await this.extension.mcp.runFlutterCommand(workspaceFolder.uri.fsPath, 'create', [
    ...
    async openDashboard() {
        try {
            ...
            const action = await vscode.window.showInformationMessage('Flutter Swarm Dashboard', 'Open in Browser', 'Show Status');
